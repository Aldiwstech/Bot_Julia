...
def generate_site_card(site_id):
  ...
  if filtered.empty:
    raise ValueError(f"Site ID '{site_id}' tidak ditemukan di Excel.")

  site_data = filtered.iloc[0]

  # 2. Buka Background Mockup
  ...
  # 3. Setup Font Proporsional (21px)
  font_size = 21
  try:
  ...
  # =========================================================================
  # 🤖 SMART DETECTION ACTION (FORMAT "NEED" PER CASE)
  # =========================================================================
  ...
  # =========================================================================
  # 🛠️ RENDER GARIS DI ATAS & TEKS ACTION DI BAWAH GARIS
  # =========================================================================
  line_y = health_cfg['start_y'] + len(col_health) * health_cfg['spacing'] - 6

  # 1. Cetak Garis Pemisah (Tepat di bawah NETECO Stat)
  draw.text(
  ...
  # 2. Posisi Teks Action (Digeser ke bawah garis)
  ...
  # 3. Cetak List Action Format "NEED" Berurutan ke Bawah
  ...
  print(
      f'✅ Selesai! Garis sudah pas dan teks action berada di bawah garis:'
      f' {output_path}'
  )
  return output_path
